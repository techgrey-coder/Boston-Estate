...
export default function AboutSection() {
    ...
    `}
                        >
                            Boston Estate is committed to creating homes that go beyond walls and structures. We focus on lifestyle-driven developments that feel personal and timeless.
                        </p>
                    </div>
                </div>
            </div>
